...
/*
	...
	<body >
		...
		<header  class="header-fixed container-fluid">
			...
			<div class="header-limiter">
				...
				<nav>
					...
					<a class="smoothScroll" href="#about"><strong>About us</strong></strong></a>
					<a class="smoothScroll" href="#collection"><strong>Hand Bags</strong></a>
					<a class="smoothScroll" href="#collection"><strong>Jewelry</strong></a>
					<a class="smoothScroll" href="#collection"><strong>Watches</strong></a>
					<a class="smoothScroll" href="#collection"><strong>Clothes</strong></a>
					
					<a class="smoothScroll" href="#contact"><strong>Get in touch</strong></a>
				</nav>
	...
	<div class="container fadeInBlock">
		<center><h1 >Ladies Bangles</h1></center><hr/>
	</div>
	<div class="ui four column doubling stackable grid container">
		<!-- collections card here -->
		<!-- <div  class="ui link cards"> -->
